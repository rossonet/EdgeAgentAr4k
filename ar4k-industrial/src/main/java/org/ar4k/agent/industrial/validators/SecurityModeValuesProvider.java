 ...
 */
@Component
public class SecurityModeValuesProvider extends ValueProviderSupport {

	private final static String[] VALUES = Stream.of(SecurityMode.values()).map(SecurityMode::name)
			.toArray(String[]::new);
