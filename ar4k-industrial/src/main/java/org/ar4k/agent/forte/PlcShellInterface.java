 ...
 *
 *         Interfaccia da linea di comando per scrivere i firmware plc
 *
 */

@ShellCommandGroup("PLC Commands")
@ShellComponent
//@EnableMBeanExport
...
@RestController
@RequestMapping("/plcInterface")
public class PlcShellInterface extends AbstractShellHelper {
