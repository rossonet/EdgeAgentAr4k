...
@Import({ SpringShellAutoConfiguration.class, JLineShellAutoConfiguration.class, Anima.class,
    ...
    EdgeAuthenticationManager.class, BCryptPasswordEncoder.class, PcapShellInterface.class })
@TestPropertySource(locations = "classpath:application.properties")
@SpringBootConfiguration
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class PcapShellInterfaceTests {
  ...
  public void listCommandAndCheck() throws InterruptedException, IOException {
    ...
    assertTrue(listCommands.containsKey("analyze-pcap-file"));
    ...
    assertTrue(listCommands.containsKey("list-network-devices"));
    assertTrue(listCommands.containsKey("list-packet-analyzer"));
    assertTrue(listCommands.containsKey("play-pcap-file-on-interface"));
    assertTrue(listCommands.containsKey("quit"));
    assertTrue(listCommands.containsKey("script"));
    assertTrue(listCommands.containsKey("sniff-on-interface"));
