...
@ShellCommandGroup("Local Account Service Commands")
@ShellComponent
//@EnableMBeanExport
...
@RestController
@RequestMapping("/localAccountInterface")
public class LocalAccountShellInterface extends AbstractShellHelper {
	@Autowired
	Shell shell;
