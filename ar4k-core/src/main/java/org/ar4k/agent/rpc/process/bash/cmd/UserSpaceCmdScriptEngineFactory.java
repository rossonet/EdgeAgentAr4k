...
import org.ar4k.agent.rpc.process.bash.NativeShellRunner;
import org.ar4k.agent.rpc.process.bash.NativeShellScriptEngine;

public class UserSpaceCmdScriptEngineFactory implements ScriptEngineFactory {
  ...
  public List<String> getMimeTypes() {
    return asList("application/x-cmd", "application/x-bat", "application/bat", "application/x-msdos-program",
