...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.Builder subBuilder = null;
            if (registerData_ != null) {
              subBuilder = registerData_.toBuilder();
            }
            registerData_ = input.readMessage(org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 42: {
            ...
            lastContact_ = input.readMessage(org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return org.ar4k.agent.tunnels.http2.grpc.beacon.BeaconMirrorService.internal_static_beacon_Agent_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return org.ar4k.agent.tunnels.http2.grpc.beacon.BeaconMirrorService.internal_static_beacon_Agent_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            org.ar4k.agent.tunnels.http2.grpc.beacon.Agent.class, org.ar4k.agent.tunnels.http2.grpc.beacon.Agent.Builder.class);
  }
  ...
  private org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply registerData_;
  /**
   ...
   * <code>.beacon.RegisterReply registerData = 3;</code>
   */
  public org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply getRegisterData() {
    return registerData_ == null ? org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.getDefaultInstance() : registerData_;
  }
  /**
   * <code>.beacon.RegisterReply registerData = 3;</code>
   */
  public org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReplyOrBuilder getRegisterDataOrBuilder() {
  ...
  private org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp lastContact_;
  /**
   ...
   * <code>.beacon.Timestamp lastContact = 5;</code>
   */
  public org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp getLastContact() {
    return lastContact_ == null ? org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.getDefaultInstance() : lastContact_;
  }
  /**
   * <code>.beacon.Timestamp lastContact = 5;</code>
   */
  public org.ar4k.agent.tunnels.http2.grpc.beacon.TimestampOrBuilder getLastContactOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof org.ar4k.agent.tunnels.http2.grpc.beacon.Agent)) {
      return super.equals(obj);
    }
    org.ar4k.agent.tunnels.http2.grpc.beacon.Agent other = (org.ar4k.agent.tunnels.http2.grpc.beacon.Agent) obj;
  ...
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseFrom(
  ...
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseFrom(
  ...
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(org.ar4k.agent.tunnels.http2.grpc.beacon.Agent prototype) {
  ...
  public static final class Builder extends
      ...
      org.ar4k.agent.tunnels.http2.grpc.beacon.AgentOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return org.ar4k.agent.tunnels.http2.grpc.beacon.BeaconMirrorService.internal_static_beacon_Agent_descriptor;
    }
    ...
    // Construct using org.ar4k.agent.tunnels.http2.grpc.beacon.Agent.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public org.ar4k.agent.tunnels.http2.grpc.beacon.Agent getDefaultInstanceForType() {
      return org.ar4k.agent.tunnels.http2.grpc.beacon.Agent.getDefaultInstance();
    }

    @java.lang.Override
    public org.ar4k.agent.tunnels.http2.grpc.beacon.Agent build() {
      org.ar4k.agent.tunnels.http2.grpc.beacon.Agent result = buildPartial();
    ...
    @java.lang.Override
    public org.ar4k.agent.tunnels.http2.grpc.beacon.Agent buildPartial() {
      org.ar4k.agent.tunnels.http2.grpc.beacon.Agent result = new org.ar4k.agent.tunnels.http2.grpc.beacon.Agent(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof org.ar4k.agent.tunnels.http2.grpc.beacon.Agent) {
        return mergeFrom((org.ar4k.agent.tunnels.http2.grpc.beacon.Agent)other);
      } else {
    ...
    public Builder mergeFrom(org.ar4k.agent.tunnels.http2.grpc.beacon.Agent other) {
      if (other == org.ar4k.agent.tunnels.http2.grpc.beacon.Agent.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      org.ar4k.agent.tunnels.http2.grpc.beacon.Agent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (org.ar4k.agent.tunnels.http2.grpc.beacon.Agent) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply, org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.Builder, org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReplyOrBuilder> registerDataBuilder_;
    /**
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public boolean hasRegisterData() {
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public Builder setRegisterData(org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply value) {
      if (registerDataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setRegisterData(
        org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.Builder builderForValue) {
      if (registerDataBuilder_ == null) {
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public Builder mergeRegisterData(org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply value) {
      if (registerDataBuilder_ == null) {
        if (registerData_ != null) {
          registerData_ =
            org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.newBuilder(registerData_).mergeFrom(value).buildPartial();
        } else {
          registerData_ = value;
        }
        onChanged();
     ...
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    public org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.Builder getRegisterDataBuilder() {
    ...
    public org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReplyOrBuilder getRegisterDataOrBuilder() {
      if (registerDataBuilder_ != null) {
        ...
        return registerData_ == null ?
            org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.getDefaultInstance() : registerData_;
      }
    }
    /**
     * <code>.beacon.RegisterReply registerData = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply, org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReply.Builder, org.ar4k.agent.tunnels.http2.grpc.beacon.RegisterReplyOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
    ...
    private org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp lastContact_;
    private com.google.protobuf.SingleFieldBuilderV3<
        org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp, org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.Builder, org.ar4k.agent.tunnels.http2.grpc.beacon.TimestampOrBuilder> lastContactBuilder_;
    /**
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public boolean hasLastContact() {
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public Builder setLastContact(org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp value) {
      if (lastContactBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public Builder mergeLastContact(org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp value) {
      if (lastContactBuilder_ == null) {
        if (lastContact_ != null) {
          lastContact_ =
            org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.newBuilder(lastContact_).mergeFrom(value).buildPartial();
        } else {
          lastContact_ = value;
        }
        onChanged();
     ...
     * <code>.beacon.Timestamp lastContact = 5;</code>
     */
    public org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.Builder getLastContactBuilder() {
    ...
    public org.ar4k.agent.tunnels.http2.grpc.beacon.TimestampOrBuilder getLastContactOrBuilder() {
      if (lastContactBuilder_ != null) {
        ...
        return lastContact_ == null ?
            org.ar4k.agent.tunnels.http2.grpc.beacon.Timestamp.getDefaultInstance() : lastContact_;
      }
    }
    /**
     * <code>.beacon.Timestamp lastContact = 5;</code>
  ...
  private static final org.ar4k.agent.tunnels.http2.grpc.beacon.Agent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new org.ar4k.agent.tunnels.http2.grpc.beacon.Agent();
  }

  public static org.ar4k.agent.tunnels.http2.grpc.beacon.Agent getDefaultInstance() {
