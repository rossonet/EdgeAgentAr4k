...
public interface RegisterReplyOrBuilder extends
   ...
   * <code>.beacon.Status statusRegistration = 5;</code>
   */
  org.ar4k.agent.tunnels.http2.grpc.beacon.Status getStatusRegistration();
  /**
   * <code>.beacon.Status statusRegistration = 5;</code>
   */
  org.ar4k.agent.tunnels.http2.grpc.beacon.StatusOrBuilder getStatusRegistrationOrBuilder();
