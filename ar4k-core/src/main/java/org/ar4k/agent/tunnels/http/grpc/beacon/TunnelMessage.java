...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            agentSource_ = input.readMessage(org.ar4k.agent.tunnels.http.grpc.beacon.Agent.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  private org.ar4k.agent.tunnels.http.grpc.beacon.Agent agentSource_;
  /**
   ...
   * <code>.beacon.Agent agentSource = 1;</code>
   */
  public org.ar4k.agent.tunnels.http.grpc.beacon.Agent getAgentSource() {
    return agentSource_ == null ? org.ar4k.agent.tunnels.http.grpc.beacon.Agent.getDefaultInstance() : agentSource_;
  }
  /**
   * <code>.beacon.Agent agentSource = 1;</code>
   */
  public org.ar4k.agent.tunnels.http.grpc.beacon.AgentOrBuilder getAgentSourceOrBuilder() {
   ...
   * <code>.beacon.MessageType messageType = 6;</code>
   */
  public org.ar4k.agent.tunnels.http.grpc.beacon.MessageType getMessageType() {
    @SuppressWarnings("deprecation")
    org.ar4k.agent.tunnels.http.grpc.beacon.MessageType result = org.ar4k.agent.tunnels.http.grpc.beacon.MessageType.valueOf(messageType_);
    return result == null ? org.ar4k.agent.tunnels.http.grpc.beacon.MessageType.UNRECOGNIZED : result;
  }
   ...
   * <code>.beacon.MessageStatus messageStatus = 7;</code>
   */
  public org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus getMessageStatus() {
    @SuppressWarnings("deprecation")
    org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus result = org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus.valueOf(messageStatus_);
    return result == null ? org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (messageStatus_ != org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus.channelActive.getNumber()) {
  ...
  public static final class Builder extends
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        org.ar4k.agent.tunnels.http.grpc.beacon.Agent, org.ar4k.agent.tunnels.http.grpc.beacon.Agent.Builder, org.ar4k.agent.tunnels.http.grpc.beacon.AgentOrBuilder> agentSourceBuilder_;
    /**
     * <code>.beacon.Agent agentSource = 1;</code>
     */
    public boolean hasAgentSource() {
     ...
     * <code>.beacon.Agent agentSource = 1;</code>
     */
    public Builder setAgentSource(org.ar4k.agent.tunnels.http.grpc.beacon.Agent value) {
      if (agentSourceBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.beacon.Agent agentSource = 1;</code>
     */
    public Builder mergeAgentSource(org.ar4k.agent.tunnels.http.grpc.beacon.Agent value) {
      if (agentSourceBuilder_ == null) {
        if (agentSource_ != null) {
          agentSource_ =
            org.ar4k.agent.tunnels.http.grpc.beacon.Agent.newBuilder(agentSource_).mergeFrom(value).buildPartial();
        } else {
          agentSource_ = value;
        }
        onChanged();
     ...
     * <code>.beacon.Agent agentSource = 1;</code>
     */
    public org.ar4k.agent.tunnels.http.grpc.beacon.Agent.Builder getAgentSourceBuilder() {
    ...
    public org.ar4k.agent.tunnels.http.grpc.beacon.AgentOrBuilder getAgentSourceOrBuilder() {
      if (agentSourceBuilder_ != null) {
        ...
        return agentSource_ == null ?
            org.ar4k.agent.tunnels.http.grpc.beacon.Agent.getDefaultInstance() : agentSource_;
      }
    }
    /**
     * <code>.beacon.Agent agentSource = 1;</code>
     ...
     * <code>.beacon.MessageType messageType = 6;</code>
     */
    public Builder setMessageType(org.ar4k.agent.tunnels.http.grpc.beacon.MessageType value) {
      if (value == null) {
        throw new NullPointerException();
      }
     ...
     * <code>.beacon.MessageStatus messageStatus = 7;</code>
     */
    public Builder setMessageStatus(org.ar4k.agent.tunnels.http.grpc.beacon.MessageStatus value) {
      if (value == null) {
        throw new NullPointerException();
      }
