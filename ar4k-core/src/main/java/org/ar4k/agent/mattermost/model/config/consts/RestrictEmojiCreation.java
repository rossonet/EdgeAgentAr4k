...
import org.ar4k.agent.mattermost.model.config.consts.RestrictEmojiCreation.RestrictEmojiCreationDeserializer;
...
public enum RestrictEmojiCreation implements HasCode<RestrictEmojiCreation> {
	...
	public static class RestrictEmojiCreationDeserializer extends JsonDeserializer<RestrictEmojiCreation> {
		@Override
		public RestrictEmojiCreation deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
