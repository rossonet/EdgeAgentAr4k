...
public class PluginManifest {
	...
	public static class PluginServer {
		...
		public boolean equals(final java.lang.Object o) {
			if (o == this)
				return true;
			if (!(o instanceof PluginManifest.PluginServer))
				return false;
			...
			if (this$executables == null ? other$executables != null : !this$executables.equals(other$executables))
				return false;
		...
		public java.lang.String toString() {
			return "PluginManifest.PluginServer(executables=" + this.getExecutables() + ", executable="
					+ this.getExecutable() + ")";
		}
	}
	...
	public static class PluginExecutables {
		...
		public boolean equals(final java.lang.Object o) {
			if (o == this)
				return true;
			if (!(o instanceof PluginManifest.PluginExecutables))
				return false;
			...
			if (this$linuxAmd64 == null ? other$linuxAmd64 != null : !this$linuxAmd64.equals(other$linuxAmd64))
				return false;
			final java.lang.Object this$darwinAmd64 = this.getDarwinAmd64();
			final java.lang.Object other$darwinAmd64 = other.getDarwinAmd64();
			if (this$darwinAmd64 == null ? other$darwinAmd64 != null : !this$darwinAmd64.equals(other$darwinAmd64))
				return false;
			...
			if (this$windowsAmd64 == null ? other$windowsAmd64 != null : !this$windowsAmd64.equals(other$windowsAmd64))
				return false;
			return true;
		}
		...
		@java.lang.SuppressWarnings("all")
		public java.lang.String toString() {
			return "PluginManifest.PluginExecutables(linuxAmd64=" + this.getLinuxAmd64() + ", darwinAmd64="
					+ this.getDarwinAmd64() + ", windowsAmd64=" + this.getWindowsAmd64() + ")";
		}
	}
	...
	public static class PluginSettingsSchema {
		...
		public boolean equals(final java.lang.Object o) {
			if (o == this)
				return true;
			if (!(o instanceof PluginManifest.PluginSettingsSchema))
				return false;
			...
			if (this$footer == null ? other$footer != null : !this$footer.equals(other$footer))
				return false;
			if (!java.util.Arrays.deepEquals(this.getSettings(), other.getSettings()))
				return false;
			return true;
		}
		...
		@java.lang.SuppressWarnings("all")
		public java.lang.String toString() {
			return "PluginManifest.PluginSettingsSchema(header=" + this.getHeader() + ", footer=" + this.getFooter()
					+ ", settings=" + java.util.Arrays.deepToString(this.getSettings()) + ")";
		}
	}
	...
	public static class PluginSetting {
		...
		public boolean equals(final java.lang.Object o) {
			if (o == this)
				return true;
			if (!(o instanceof PluginManifest.PluginSetting))
				return false;
			...
			if (this$regenerateHelpText == null ? other$regenerateHelpText != null
					: !this$regenerateHelpText.equals(other$regenerateHelpText))
				return false;
		...
		@java.lang.SuppressWarnings("all")
		public java.lang.String toString() {
			return "PluginManifest.PluginSetting(key=" + this.getKey() + ", displayName=" + this.getDisplayName()
					+ ", type=" + this.getType() + ", helpText=" + this.getHelpText() + ", regenerateHelpText="
					+ this.getRegenerateHelpText() + ", placeholder=" + this.getPlaceholder() + ", defaultValue="
					+ this.getDefaultValue() + ", options=" + this.getOptions() + ")";
		}
	}
	...
	public boolean equals(final java.lang.Object o) {
		if (o == this)
			return true;
		if (!(o instanceof PluginManifest))
			return false;
		...
		if (this$minServerVersion == null ? other$minServerVersion != null
		...
		if (this$webapp == null ? other$webapp != null : !this$webapp.equals(other$webapp))
			return false;
		...
		if (this$settingsSchema == null ? other$settingsSchema != null
				: !this$settingsSchema.equals(other$settingsSchema))
			return false;
	...
	public java.lang.String toString() {
		return "PluginManifest(id=" + this.getId() + ", name=" + this.getName() + ", description="
				+ this.getDescription() + ", version=" + this.getVersion() + ", minServerVersion="
				+ this.getMinServerVersion() + ", server=" + this.getServer() + ", backend=" + this.getBackend()
				+ ", webapp=" + this.getWebapp() + ", settingsSchema=" + this.getSettingsSchema() + ", homepageUrl="
				+ this.getHomepageUrl() + ", supportUrl=" + this.getSupportUrl() + ", iconPath=" + this.getIconPath()
				+ ")";
	}
}
