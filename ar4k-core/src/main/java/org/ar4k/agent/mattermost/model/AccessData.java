...
public class AccessData {
	...
	public java.lang.String toString() {
		return "AccessData(clientId=" + this.getClientId() + ", userId=" + this.getUserId() + ", token="
				+ this.getToken() + ", refreshToken=" + this.getRefreshToken() + ", redirectUri="
				+ this.getRedirectUri() + ", expiresAt=" + this.getExpiresAt() + ", scope=" + this.getScope() + ")";
	}
}
