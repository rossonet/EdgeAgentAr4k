...
public class Channel {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.getDeleteAt() != other.getDeleteAt())
			return false;
		if (this.getLastPostat() != other.getLastPostat())
			return false;
		if (this.getTotalMsgCount() != other.getTotalMsgCount())
			return false;
		if (this.getExtraUpdateAt() != other.getExtraUpdateAt())
			return false;
	...
	public java.lang.String toString() {
		return "Channel(id=" + this.getId() + ", createAt=" + this.getCreateAt() + ", updateAt=" + this.getUpdateAt()
				+ ", deleteAt=" + this.getDeleteAt() + ", teamId=" + this.getTeamId() + ", type=" + this.getType()
				+ ", displayName=" + this.getDisplayName() + ", name=" + this.getName() + ", header=" + this.getHeader()
				+ ", purpose=" + this.getPurpose() + ", lastPostat=" + this.getLastPostat() + ", totalMsgCount="
				+ this.getTotalMsgCount() + ", extraUpdateAt=" + this.getExtraUpdateAt() + ", creatorId="
				+ this.getCreatorId() + ", schemeId=" + this.getSchemeId() + ", props=" + this.getProps()
				+ ", groupConstrained=" + this.isGroupConstrained() + ")";
	}
