...
import org.ar4k.agent.mattermost.model.config.consts.saml.SignatureAlgorithm.SignatureAlgorithmDeserializer;
...
public enum SignatureAlgorithm implements HasCode<SignatureAlgorithm> {
	...
	private SignatureAlgorithm(final String code) {
		this.code = code;
	}
