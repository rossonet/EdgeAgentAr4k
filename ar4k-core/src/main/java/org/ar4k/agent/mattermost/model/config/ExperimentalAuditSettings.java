...
public class ExperimentalAuditSettings {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof ExperimentalAuditSettings)) return false;
    final ExperimentalAuditSettings other = (ExperimentalAuditSettings) o;
    if (!other.canEqual((java.lang.Object) this)) return false;
    if (this.isSysLogEnabled() != other.isSysLogEnabled()) return false;
    if (this.getSysLogPort() != other.getSysLogPort()) return false;
    if (this.isSysLogInsecure() != other.isSysLogInsecure()) return false;
    if (this.getSysLogMaxQueueSize() != other.getSysLogMaxQueueSize()) return false;
    if (this.isFileEnabled() != other.isFileEnabled()) return false;
    if (this.getFileMaxSizeMb() != other.getFileMaxSizeMb()) return false;
    if (this.getFileMaxAgeDays() != other.getFileMaxAgeDays()) return false;
    if (this.getFileMaxBackups() != other.getFileMaxBackups()) return false;
    if (this.isFileCompress() != other.isFileCompress()) return false;
    if (this.getFileMaxQueueSize() != other.getFileMaxQueueSize()) return false;
    final java.lang.Object this$sysLogIp = this.getSysLogIp();
    final java.lang.Object other$sysLogIp = other.getSysLogIp();
    if (this$sysLogIp == null ? other$sysLogIp != null : !this$sysLogIp.equals(other$sysLogIp)) return false;
    final java.lang.Object this$sysLogTag = this.getSysLogTag();
    final java.lang.Object other$sysLogTag = other.getSysLogTag();
    if (this$sysLogTag == null ? other$sysLogTag != null : !this$sysLogTag.equals(other$sysLogTag)) return false;
    final java.lang.Object this$sysLogCert = this.getSysLogCert();
    final java.lang.Object other$sysLogCert = other.getSysLogCert();
    if (this$sysLogCert == null ? other$sysLogCert != null : !this$sysLogCert.equals(other$sysLogCert)) return false;
  ...
  public java.lang.String toString() {
    return "ExperimentalAuditSettings(sysLogEnabled=" + this.isSysLogEnabled() + ", sysLogIp=" + this.getSysLogIp() + ", sysLogPort=" + this.getSysLogPort() + ", sysLogTag=" + this.getSysLogTag() + ", sysLogCert=" + this.getSysLogCert() + ", sysLogInsecure=" + this.isSysLogInsecure() + ", sysLogMaxQueueSize=" + this.getSysLogMaxQueueSize() + ", fileEnabled=" + this.isFileEnabled() + ", fileName=" + this.getFileName() + ", fileMaxSizeMb=" + this.getFileMaxSizeMb() + ", fileMaxAgeDays=" + this.getFileMaxAgeDays() + ", fileMaxBackups=" + this.getFileMaxBackups() + ", fileCompress=" + this.isFileCompress() + ", fileMaxQueueSize=" + this.getFileMaxQueueSize() + ")";
  }
}
