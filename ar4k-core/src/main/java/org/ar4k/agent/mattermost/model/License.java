...
public class License {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (this.getIssuedAt() != other.getIssuedAt()) return false;
    if (this.getStartsAt() != other.getStartsAt()) return false;
  ...
  public java.lang.String toString() {
    return "License(id=" + this.getId() + ", issuedAt=" + this.getIssuedAt() + ", startsAt=" + this.getStartsAt() + ", expiresAt=" + this.getExpiresAt() + ", customer=" + this.getCustomer() + ", features=" + this.getFeatures() + ")";
  }
}
