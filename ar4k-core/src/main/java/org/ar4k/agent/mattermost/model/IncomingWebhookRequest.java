...
public class IncomingWebhookRequest {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof IncomingWebhookRequest)) return false;
  ...
  public java.lang.String toString() {
    return "IncomingWebhookRequest(text=" + this.getText() + ", username=" + this.getUsername() + ", iconUrl=" + this.getIconUrl() + ", channel=" + this.getChannel() + ", props=" + this.getProps() + ", attachments=" + this.getAttachments() + ", type=" + this.getType() + ", iconEmoji=" + this.getIconEmoji() + ")";
  }
}
