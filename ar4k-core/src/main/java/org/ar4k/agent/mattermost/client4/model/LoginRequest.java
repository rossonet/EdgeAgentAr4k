...
public final class LoginRequest {
	...
	LoginRequest(final String id, final String loginId, final String password, final boolean ldapOnly,
	...
	public static class LoginRequestBuilder {
		...
		public java.lang.String toString() {
			return "LoginRequest.LoginRequestBuilder(id=" + this.id + ", loginId=" + this.loginId + ", password="
					+ this.password + ", ldapOnly=" + this.ldapOnly + ", deviceId=" + this.deviceId + ")";
		}
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.isLdapOnly() != other.isLdapOnly())
			return false;
	...
	@java.lang.SuppressWarnings("all")
	public java.lang.String toString() {
		return "LoginRequest(id=" + this.getId() + ", loginId=" + this.getLoginId() + ", password=" + this.getPassword()
				+ ", ldapOnly=" + this.isLdapOnly() + ", deviceId=" + this.getDeviceId() + ")";
	}
}
