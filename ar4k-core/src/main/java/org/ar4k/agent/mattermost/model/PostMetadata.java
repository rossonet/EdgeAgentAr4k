...
public class PostMetadata {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof PostMetadata)) return false;
    final PostMetadata other = (PostMetadata) o;
    if (!other.canEqual((java.lang.Object) this)) return false;
    if (!java.util.Arrays.deepEquals(this.getEmbeds(), other.getEmbeds())) return false;
    if (!java.util.Arrays.deepEquals(this.getEmojis(), other.getEmojis())) return false;
    if (!java.util.Arrays.deepEquals(this.getFiles(), other.getFiles())) return false;
    ...
    if (!java.util.Arrays.deepEquals(this.getReactions(), other.getReactions())) return false;
    return true;
  }
  ...
  public java.lang.String toString() {
    return "PostMetadata(embeds=" + java.util.Arrays.deepToString(this.getEmbeds()) + ", emojis=" + java.util.Arrays.deepToString(this.getEmojis()) + ", files=" + java.util.Arrays.deepToString(this.getFiles()) + ", images=" + this.getImages() + ", reactions=" + java.util.Arrays.deepToString(this.getReactions()) + ")";
  }
}
