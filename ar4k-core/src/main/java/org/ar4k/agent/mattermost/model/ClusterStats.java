...
public class ClusterStats {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof ClusterStats)) return false;
    final ClusterStats other = (ClusterStats) o;
    if (!other.canEqual((java.lang.Object) this)) return false;
    if (this.getTotalWebsocketConnections() != other.getTotalWebsocketConnections()) return false;
    if (this.getTotalReadDbConnections() != other.getTotalReadDbConnections()) return false;
    if (this.getTotalMasterDbConnections() != other.getTotalMasterDbConnections()) return false;
  ...
  public java.lang.String toString() {
    return "ClusterStats(id=" + this.getId() + ", totalWebsocketConnections=" + this.getTotalWebsocketConnections() + ", totalReadDbConnections=" + this.getTotalReadDbConnections() + ", totalMasterDbConnections=" + this.getTotalMasterDbConnections() + ")";
  }
}
