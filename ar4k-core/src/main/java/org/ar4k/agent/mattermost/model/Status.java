...
public class Status {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$activeChannel == null ? other$activeChannel != null : !this$activeChannel.equals(other$activeChannel))
			return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "Status(userId=" + this.getUserId() + ", status=" + this.getStatus() + ", manual=" + this.isManual()
				+ ", lastActivityAt=" + this.getLastActivityAt() + ", activeChannel=" + this.getActiveChannel() + ")";
	}
}
