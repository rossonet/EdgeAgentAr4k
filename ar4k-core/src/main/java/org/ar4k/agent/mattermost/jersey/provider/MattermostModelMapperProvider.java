...
package org.ar4k.agent.mattermost.jersey.provider;

import org.ar4k.agent.mattermost.model.Config;
import org.ar4k.agent.mattermost.model.serialize.MattermostPropertyNamingStrategy;
...
public class MattermostModelMapperProvider implements ContextResolver<ObjectMapper> {
	...
	public ObjectMapper getContext(Class<?> type) {
		if (type == Config.class || type.getName().startsWith("org.ar4k.agent.core.mattermost.model.config")) {
