...
public class AuthData {
  ...
  public java.lang.String toString() {
    return "AuthData(clientId=" + this.getClientId() + ", userId=" + this.getUserId() + ", code=" + this.getCode() + ", expiresIn=" + this.getExpiresIn() + ", createAt=" + this.getCreateAt() + ", redirectUrl=" + this.getRedirectUrl() + ", state=" + this.getState() + ", scope=" + this.getScope() + ")";
  }
}
