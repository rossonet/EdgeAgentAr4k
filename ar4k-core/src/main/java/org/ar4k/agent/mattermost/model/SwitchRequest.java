...
public class SwitchRequest {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$currentService == null ? other$currentService != null
				: !this$currentService.equals(other$currentService))
			return false;
		final java.lang.Object this$newService = this.getNewService();
		final java.lang.Object other$newService = other.getNewService();
		if (this$newService == null ? other$newService != null : !this$newService.equals(other$newService))
			return false;
		...
		if (this$mfaCode == null ? other$mfaCode != null : !this$mfaCode.equals(other$mfaCode))
			return false;
		final java.lang.Object this$ldapId = this.getLdapId();
		final java.lang.Object other$ldapId = other.getLdapId();
		if (this$ldapId == null ? other$ldapId != null : !this$ldapId.equals(other$ldapId))
			return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "SwitchRequest(currentService=" + this.getCurrentService() + ", newService=" + this.getNewService()
				+ ", email=" + this.getEmail() + ", currentPassword=" + this.getCurrentPassword() + ", password="
				+ this.getPassword() + ", newPassword=" + this.getNewPassword() + ", mfaCode=" + this.getMfaCode()
