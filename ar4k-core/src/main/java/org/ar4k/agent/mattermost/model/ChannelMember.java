...
public class ChannelMember {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!other.canEqual((java.lang.Object) this))
			return false;
		if (this.getLastViewedAt() != other.getLastViewedAt())
			return false;
		if (this.getMsgCount() != other.getMsgCount())
			return false;
		if (this.getMentionCount() != other.getMentionCount())
			return false;
		if (this.getLastUpdateAt() != other.getLastUpdateAt())
			return false;
		if (this.isSchemeUser() != other.isSchemeUser())
			return false;
		if (this.isSchemeAdmin() != other.isSchemeAdmin())
			return false;
		if (this.isSchemeGuest() != other.isSchemeGuest())
			return false;
		...
		if (this$explicitRoles == null ? other$explicitRoles != null : !this$explicitRoles.equals(other$explicitRoles))
			return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "ChannelMember(channelId=" + this.getChannelId() + ", userId=" + this.getUserId() + ", roles="
				+ this.getRoles() + ", lastViewedAt=" + this.getLastViewedAt() + ", msgCount=" + this.getMsgCount()
				+ ", mentionCount=" + this.getMentionCount() + ", notifyProps=" + this.getNotifyProps()
				+ ", lastUpdateAt=" + this.getLastUpdateAt() + ", schemeUser=" + this.isSchemeUser() + ", schemeAdmin="
				+ this.isSchemeAdmin() + ", explicitRoles=" + this.getExplicitRoles() + ", schemeGuest="
				+ this.isSchemeGuest() + ")";
	}
}
