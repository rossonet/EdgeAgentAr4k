...
import org.ar4k.agent.mattermost.model.config.consts.ConnectionSecurity.ConnectionSecuritySerializer;
...
public enum ConnectionSecurity implements HasCode<ConnectionSecurity> {
	...
	public static class ConnectionSecuritySerializer extends JsonDeserializer<ConnectionSecurity> {
		@Override
		public ConnectionSecurity deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
