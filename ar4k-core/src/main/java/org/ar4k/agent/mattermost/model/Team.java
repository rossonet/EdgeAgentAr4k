...
public class Team {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.isAllowOpenInvite() != other.isAllowOpenInvite())
			return false;
		if (this.getLastTeamIconUpdate() != other.getLastTeamIconUpdate())
			return false;
		if (this.isGroupConstrained() != other.isGroupConstrained())
			return false;
		...
		if (this$allowedDomains == null ? other$allowedDomains != null
				: !this$allowedDomains.equals(other$allowedDomains))
			return false;
		...
		if (this$schemeId == null ? other$schemeId != null : !this$schemeId.equals(other$schemeId))
			return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "Team(id=" + this.getId() + ", createAt=" + this.getCreateAt() + ", updateAt=" + this.getUpdateAt()
				+ ", deleteAt=" + this.getDeleteAt() + ", displayName=" + this.getDisplayName() + ", name="
				+ this.getName() + ", description=" + this.getDescription() + ", email=" + this.getEmail() + ", type="
				+ this.getType() + ", companyName=" + this.getCompanyName() + ", allowedDomains="
				+ this.getAllowedDomains() + ", inviteId=" + this.getInviteId() + ", allowOpenInvite="
				+ this.isAllowOpenInvite() + ", lastTeamIconUpdate=" + this.getLastTeamIconUpdate() + ", schemeId="
				+ this.getSchemeId() + ", groupConstrained=" + this.isGroupConstrained() + ")";
	}
}
