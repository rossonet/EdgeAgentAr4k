...
public class Reaction {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (this$emojiName == null ? other$emojiName != null : !this$emojiName.equals(other$emojiName)) return false;
    return true;
  }
  ...
  public java.lang.String toString() {
    return "Reaction(userId=" + this.getUserId() + ", postId=" + this.getPostId() + ", emojiName=" + this.getEmojiName() + ", createAt=" + this.getCreateAt() + ")";
  }
}
