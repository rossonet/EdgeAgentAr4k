...
public class User {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (this.isAllowMarketing() != other.isAllowMarketing()) return false;
    if (this.getLastPasswordUpdate() != other.getLastPasswordUpdate()) return false;
    if (this.getLastPictureUpdate() != other.getLastPictureUpdate()) return false;
    if (this.getFailedAttempts() != other.getFailedAttempts()) return false;
    if (this.isMfaActive() != other.isMfaActive()) return false;
    ...
    if (this$authData == null ? other$authData != null : !this$authData.equals(other$authData)) return false;
    final java.lang.Object this$authService = this.getAuthService();
    final java.lang.Object other$authService = other.getAuthService();
    if (this$authService == null ? other$authService != null : !this$authService.equals(other$authService)) return false;
    ...
    if (this$mfaSecret == null ? other$mfaSecret != null : !this$mfaSecret.equals(other$mfaSecret)) return false;
    ...
    if (this$botDescription == null ? other$botDescription != null : !this$botDescription.equals(other$botDescription)) return false;
    return true;
  }
  ...
  public java.lang.String toString() {
    return "User(id=" + this.getId() + ", createAt=" + this.getCreateAt() + ", updateAt=" + this.getUpdateAt() + ", deleteAt=" + this.getDeleteAt() + ", username=" + this.getUsername() + ", password=" + this.getPassword() + ", authData=" + this.getAuthData() + ", authService=" + this.getAuthService() + ", email=" + this.getEmail() + ", emailVerified=" + this.isEmailVerified() + ", nickname=" + this.getNickname() + ", firstName=" + this.getFirstName() + ", lastName=" + this.getLastName() + ", position=" + this.getPosition() + ", roles=" + this.getRoles() + ", allowMarketing=" + this.isAllowMarketing() + ", props=" + this.getProps() + ", notifyProps=" + this.getNotifyProps() + ", lastPasswordUpdate=" + this.getLastPasswordUpdate() + ", lastPictureUpdate=" + this.getLastPictureUpdate() + ", failedAttempts=" + this.getFailedAttempts() + ", locale=" + this.getLocale() + ", mfaActive=" + this.isMfaActive() + ", mfaSecret=" + this.getMfaSecret() + ", lastActivityAt=" + this.getLastActivityAt() + ", timezone=" + this.getTimezone() + ", isBot=" + this.isBot() + ", botDescription=" + this.getBotDescription() + ")";
  }
}
