...
public class OAuthApp {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof OAuthApp)) return false;
    ...
    if (this.isTrusted() != other.isTrusted()) return false;
  ...
  public java.lang.String toString() {
    return "OAuthApp(id=" + this.getId() + ", creatorId=" + this.getCreatorId() + ", createAt=" + this.getCreateAt() + ", updateAt=" + this.getUpdateAt() + ", clientSecret=" + this.getClientSecret() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", iconUrl=" + this.getIconUrl() + ", callbackUrls=" + this.getCallbackUrls() + ", homepage=" + this.getHomepage() + ", isTrusted=" + this.isTrusted() + ")";
  }
}
