...
public class UserAccessToken {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof UserAccessToken)) return false;
  ...
  public java.lang.String toString() {
    return "UserAccessToken(id=" + this.getId() + ", token=" + this.getToken() + ", userId=" + this.getUserId() + ", description=" + this.getDescription() + ", isActive=" + this.isActive() + ")";
  }
}
