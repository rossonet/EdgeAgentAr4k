...
import org.ar4k.agent.mattermost.model.config.consts.GroupUnreadChannels.GroupUnreadChannelsDeserializer;
...
public enum GroupUnreadChannels implements HasCode<GroupUnreadChannels> {
	...
	public static class GroupUnreadChannelsDeserializer extends JsonDeserializer<GroupUnreadChannels> {
		@Override
		public GroupUnreadChannels deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
	...
	@java.lang.SuppressWarnings("all")
	private GroupUnreadChannels(final String code) {
		this.code = code;
	}
}
