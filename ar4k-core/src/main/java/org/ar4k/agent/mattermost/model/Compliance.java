...
public class Compliance {
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    if (!(o instanceof Compliance)) return false;
    final Compliance other = (Compliance) o;
    if (!other.canEqual((java.lang.Object) this)) return false;
    if (this.getCreateAt() != other.getCreateAt()) return false;
    if (this.getCount() != other.getCount()) return false;
    if (this.getStartAt() != other.getStartAt()) return false;
    if (this.getEndAt() != other.getEndAt()) return false;
  ...
  public java.lang.String toString() {
    return "Compliance(id=" + this.getId() + ", createAt=" + this.getCreateAt() + ", userId=" + this.getUserId() + ", status=" + this.getStatus() + ", count=" + this.getCount() + ", desc=" + this.getDesc() + ", type=" + this.getType() + ", startAt=" + this.getStartAt() + ", endAt=" + this.getEndAt() + ", keywords=" + this.getKeywords() + ", emails=" + this.getEmails() + ")";
  }
}
