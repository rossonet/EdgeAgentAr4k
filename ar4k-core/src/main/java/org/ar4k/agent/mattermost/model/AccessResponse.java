...
public class AccessResponse {
	...
	public boolean equals(final java.lang.Object o) {
		if (o == this)
			return true;
		if (!(o instanceof AccessResponse))
			return false;
	...
	public java.lang.String toString() {
		return "AccessResponse(accessToken=" + this.getAccessToken() + ", tokenType=" + this.getTokenType()
				+ ", expiresIn=" + this.getExpiresIn() + ", scope=" + this.getScope() + ", refreshToken="
