...
public class ServiceSettings {
	...
	@java.lang.SuppressWarnings("all")
	public void setExperimentalEnableDefaultChannelLeaveJoinMessages(
			final boolean experimentalEnableDefaultChannelLeaveJoinMessages) {
	...
	@java.lang.SuppressWarnings("all")
	public void setExperimentalChannelSidebarOrganization(
			final ChannelSidebarOrganization experimentalChannelSidebarOrganization) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.isEnableTutorial() != other.isEnableTutorial())
			return false;
		if (this.getMinimumHashtagLength() != other.getMinimumHashtagLength())
			return false;
		if (this.isDisableBotsWhenOwnerIsDeactivated() != other.isDisableBotsWhenOwnerIsDeactivated())
			return false;
		if (this.isExperimentalEnableDefaultChannelLeaveJoinMessages() != other
		...
		if (this.getTlsStrictTransportMaxAge() != other.getTlsStrictTransportMaxAge())
			return false;
		if (this.isExperimentalLdapGroupSync() != other.isExperimentalLdapGroupSync())
			return false;
		if (this.isExperimentalStrictCsrfEnforcement() != other.isExperimentalStrictCsrfEnforcement())
			return false;
		if (this.isDisableLegacyMfa() != other.isDisableLegacyMfa())
			return false;
		if (this.isEnableBotAccountCreation() != other.isEnableBotAccountCreation())
			return false;
		if (this.isEnableSvgs() != other.isEnableSvgs())
			return false;
		if (this.isEnableLatex() != other.isEnableLatex())
			return false;
		if (this.isEnableOpenTracing() != other.isEnableOpenTracing())
			return false;
		...
		if (this$licenseFileLocation == null ? other$licenseFileLocation != null
				: !this$licenseFileLocation.equals(other$licenseFileLocation))
			return false;
		...
		if (this$letsEncryptCertificateCacheFile == null ? other$letsEncryptCertificateCacheFile != null
				: !this$letsEncryptCertificateCacheFile.equals(other$letsEncryptCertificateCacheFile))
			return false;
		...
		if (this$googleDeveloperKey == null ? other$googleDeveloperKey != null
				: !this$googleDeveloperKey.equals(other$googleDeveloperKey))
			return false;
		...
		if (this$restrictCustomEmojiCreation == null ? other$restrictCustomEmojiCreation != null
				: !this$restrictCustomEmojiCreation.equals(other$restrictCustomEmojiCreation))
			return false;
		...
		if (this$restrictPostDelete == null ? other$restrictPostDelete != null
				: !this$restrictPostDelete.equals(other$restrictPostDelete))
			return false;
		...
		final java.lang.Object other$allowedUntrustedInternalConnections = other
				.getAllowedUntrustedInternalConnections();
		if (this$allowedUntrustedInternalConnections == null ? other$allowedUntrustedInternalConnections != null
				: !this$allowedUntrustedInternalConnections.equals(other$allowedUntrustedInternalConnections))
			return false;
		...
		if (this$imageProxyType == null ? other$imageProxyType != null
				: !this$imageProxyType.equals(other$imageProxyType))
			return false;
		...
		if (this$imageProxyOptions == null ? other$imageProxyOptions != null
				: !this$imageProxyOptions.equals(other$imageProxyOptions))
			return false;
		...
		if (this$experimentalGroupUnreadChannels == null ? other$experimentalGroupUnreadChannels != null
				: !this$experimentalGroupUnreadChannels.equals(other$experimentalGroupUnreadChannels))
			return false;
		...
		if (this$gfycatApiSecret == null ? other$gfycatApiSecret != null
				: !this$gfycatApiSecret.equals(other$gfycatApiSecret))
			return false;
		...
		if (this$corsExposedHeaders == null ? other$corsExposedHeaders != null
				: !this$corsExposedHeaders.equals(other$corsExposedHeaders))
			return false;
		...
		if (this$tlsOverwriteCiphers == null ? other$tlsOverwriteCiphers != null
				: !this$tlsOverwriteCiphers.equals(other$tlsOverwriteCiphers))
			return false;
		...
		if (this$trustedProxyIpHeader == null ? other$trustedProxyIpHeader != null
				: !this$trustedProxyIpHeader.equals(other$trustedProxyIpHeader))
			return false;
		final java.lang.Object this$experimentalChannelSidebarOrganization = this
				.getExperimentalChannelSidebarOrganization();
		final java.lang.Object other$experimentalChannelSidebarOrganization = other
				.getExperimentalChannelSidebarOrganization();
		if (this$experimentalChannelSidebarOrganization == null ? other$experimentalChannelSidebarOrganization != null
				: !this$experimentalChannelSidebarOrganization.equals(other$experimentalChannelSidebarOrganization))
			return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME
				+ (int) ($timeBetweenUserTypingUpdatesMilliseconds >>> 32 ^ $timeBetweenUserTypingUpdatesMilliseconds);
		...
		result = result * PRIME
				+ ($letsEncryptCertificateCacheFile == null ? 43 : $letsEncryptCertificateCacheFile.hashCode());
		...
		result = result * PRIME
				+ ($allowedUntrustedInternalConnections == null ? 43 : $allowedUntrustedInternalConnections.hashCode());
		...
		result = result * PRIME
				+ ($experimentalGroupUnreadChannels == null ? 43 : $experimentalGroupUnreadChannels.hashCode());
		...
		final java.lang.Object $experimentalChannelSidebarOrganization = this
				.getExperimentalChannelSidebarOrganization();
		result = result * PRIME + ($experimentalChannelSidebarOrganization == null ? 43
				: $experimentalChannelSidebarOrganization.hashCode());
		return result;
	}
	...
	public java.lang.String toString() {
		return "ServiceSettings(siteUrl=" + this.getSiteUrl() + ", licenseFileLocation=" + this.getLicenseFileLocation()
				+ ", listenAddress=" + this.getListenAddress() + ", connectionSecurity=" + this.getConnectionSecurity()
				+ ", tlsCertFile=" + this.getTlsCertFile() + ", tlsKeyFile=" + this.getTlsKeyFile()
				+ ", useLetsEncrypt=" + this.isUseLetsEncrypt() + ", letsEncryptCertificateCacheFile="
				+ this.getLetsEncryptCertificateCacheFile() + ", forward80To443=" + this.isForward80To443()
				+ ", readTimeout=" + this.getReadTimeout() + ", writeTimeout=" + this.getWriteTimeout()
				+ ", maximumLoginAttempts=" + this.getMaximumLoginAttempts() + ", googleDeveloperKey="
				+ this.getGoogleDeveloperKey() + ", enableOAuthServiceProvider=" + this.isEnableOAuthServiceProvider()
				+ ", enableIncomingWebhooks=" + this.isEnableIncomingWebhooks() + ", enableOutgoingWebhooks="
				+ this.isEnableOutgoingWebhooks() + ", enableCommands=" + this.isEnableCommands()
				+ ", enableOnlyAdminIntegrations=" + this.isEnableOnlyAdminIntegrations()
				+ ", enablePostUsernameOverride=" + this.isEnablePostUsernameOverride() + ", enablePostIconOverride="
				+ this.isEnablePostIconOverride() + ", enableLinkPreviews=" + this.isEnableLinkPreviews()
				+ ", enableTesting=" + this.isEnableTesting() + ", enableDeveloper=" + this.isEnableDeveloper()
				+ ", enableSecurityFixAlert=" + this.isEnableSecurityFixAlert() + ", enableInsecureOutgoingConnections="
				+ this.isEnableInsecureOutgoingConnections() + ", enableMultifactorAuthentication="
				+ this.isEnableMultifactorAuthentication() + ", enforceMultifactorAuthentication="
				+ this.isEnforceMultifactorAuthentication() + ", allowCorsFrom=" + this.getAllowCorsFrom()
				+ ", sessionLengthWebInDays=" + this.getSessionLengthWebInDays() + ", sessionLengthMobileInDays="
				+ this.getSessionLengthMobileInDays() + ", sessionLengthSsoInDays=" + this.getSessionLengthSsoInDays()
				+ ", sessionCacheInMinutes=" + this.getSessionCacheInMinutes() + ", websocketSecurePort="
				+ this.getWebsocketSecurePort() + ", websocketPort=" + this.getWebsocketPort() + ", webServerMode="
				+ this.getWebServerMode() + ", enableCustomEmoji=" + this.isEnableCustomEmoji()
				+ ", restrictCustomEmojiCreation=" + this.getRestrictCustomEmojiCreation() + ", restrictPostDelete="
				+ this.getRestrictPostDelete() + ", allowEditPost=" + this.getAllowEditPost() + ", postEditTimeLimit="
				+ this.getPostEditTimeLimit() + ", timeBetweenUserTypingUpdatesMilliseconds="
				+ this.getTimeBetweenUserTypingUpdatesMilliseconds() + ", enablePostSearch=" + this.isEnablePostSearch()
				+ ", enableUserTypingMessages=" + this.isEnableUserTypingMessages() + ", enableUserStatuses="
				+ this.isEnableUserStatuses() + ", clusterLogTimeoutMilliseconds="
				+ this.getClusterLogTimeoutMilliseconds() + ", goroutineHealthThreshold="
				+ this.getGoroutineHealthThreshold() + ", enableEmojiPicker=" + this.isEnableEmojiPicker()
				+ ", enableChannelViewedMessages=" + this.isEnableChannelViewedMessages() + ", enableApiv3="
				+ this.isEnableApiv3() + ", enableUserAccessTokens=" + this.isEnableUserAccessTokens()
				+ ", allowedUntrustedInternalConnections=" + this.getAllowedUntrustedInternalConnections()
				+ ", sessionIdleTimeoutInMinutes=" + this.getSessionIdleTimeoutInMinutes()
				+ ", closeUnusedDirectMessages=" + this.isCloseUnusedDirectMessages() + ", enablePreviewFeatures="
				+ this.isEnablePreviewFeatures() + ", experimentalEnableAuthenticationTransfer="
				+ this.isExperimentalEnableAuthenticationTransfer() + ", enableTutorial=" + this.isEnableTutorial()
				+ ", imageProxyType=" + this.getImageProxyType() + ", minimumHashtagLength="
				+ this.getMinimumHashtagLength() + ", disableBotsWhenOwnerIsDeactivated="
				+ this.isDisableBotsWhenOwnerIsDeactivated() + ", imageProxyOptions=" + this.getImageProxyOptions()
				+ ", imageProxyUrl=" + this.getImageProxyUrl() + ", experimentalGroupUnreadChannels="
				+ this.getExperimentalGroupUnreadChannels() + ", experimentalEnableDefaultChannelLeaveJoinMessages="
				+ this.isExperimentalEnableDefaultChannelLeaveJoinMessages() + ", allowCookiesForSubdomains="
				+ this.isAllowCookiesForSubdomains() + ", websocketUrl=" + this.getWebsocketUrl()
				+ ", enableEmailInvitations=" + this.isEnableEmailInvitations() + ", enableApiTeamDeletion="
				+ this.isEnableApiTeamDeletion() + ", experimentalEnableHardenedMode="
				+ this.isExperimentalEnableHardenedMode() + ", enableGifPicker=" + this.isEnableGifPicker()
				+ ", gfycatApiKey=" + this.getGfycatApiKey() + ", gfycatApiSecret=" + this.getGfycatApiSecret()
				+ ", experimentalLimitClientConfig=" + this.isExperimentalLimitClientConfig() + ", corsExposedHeaders="
				+ this.getCorsExposedHeaders() + ", corsAllowCredentials=" + this.isCorsAllowCredentials()
				+ ", corsDebug=" + this.isCorsDebug() + ", experimentalChannelOrganization="
				+ this.isExperimentalChannelOrganization() + ", tlsMinVer=" + this.getTlsMinVer()
				+ ", tlsStrictTransport=" + this.isTlsStrictTransport() + ", tlsStrictTransportMaxAge="
				+ this.getTlsStrictTransportMaxAge() + ", tlsOverwriteCiphers=" + this.getTlsOverwriteCiphers()
				+ ", experimentalLdapGroupSync=" + this.isExperimentalLdapGroupSync()
				+ ", experimentalStrictCsrfEnforcement=" + this.isExperimentalStrictCsrfEnforcement()
				+ ", disableLegacyMfa=" + this.isDisableLegacyMfa() + ", trustedProxyIpHeader="
				+ this.getTrustedProxyIpHeader() + ", enableBotAccountCreation=" + this.isEnableBotAccountCreation()
				+ ", enableSvgs=" + this.isEnableSvgs() + ", enableLatex=" + this.isEnableLatex()
				+ ", enableOpenTracing=" + this.isEnableOpenTracing() + ", idleTimeout=" + this.getIdleTimeout()
				+ ", experimentalChannelSidebarOrganization=" + this.getExperimentalChannelSidebarOrganization() + ")";
	}
