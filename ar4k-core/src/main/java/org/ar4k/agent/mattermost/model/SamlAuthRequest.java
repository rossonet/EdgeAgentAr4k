...
public class SamlAuthRequest {
	...
	public boolean equals(final java.lang.Object o) {
		if (o == this)
			return true;
		if (!(o instanceof SamlAuthRequest))
			return false;
		...
		if (this$base64AuthRequest == null ? other$base64AuthRequest != null
				: !this$base64AuthRequest.equals(other$base64AuthRequest))
			return false;
		...
		if (this$relayState == null ? other$relayState != null : !this$relayState.equals(other$relayState))
			return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "SamlAuthRequest(base64AuthRequest=" + this.getBase64AuthRequest() + ", url=" + this.getUrl()
