...
import org.ar4k.agent.mattermost.model.config.consts.EmailNotificationContent.EmailNotificationContentDeserializer;
...
public enum EmailNotificationContent implements HasCode<EmailNotificationContent> {
	...
	@java.lang.SuppressWarnings("all")
	private EmailNotificationContent(final String code) {
		this.code = code;
	}
}
