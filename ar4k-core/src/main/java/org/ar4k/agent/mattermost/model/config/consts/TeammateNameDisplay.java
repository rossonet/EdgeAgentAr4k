...
import org.ar4k.agent.mattermost.model.config.consts.TeammateNameDisplay.TeammateNameDisplayDeserializer;
...
public enum TeammateNameDisplay implements HasCode<TeammateNameDisplay> {
	...
	public static class TeammateNameDisplayDeserializer extends JsonDeserializer<TeammateNameDisplay> {
		@Override
		public TeammateNameDisplay deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
	...
	@java.lang.SuppressWarnings("all")
	private TeammateNameDisplay(final String code) {
		this.code = code;
	}
}
