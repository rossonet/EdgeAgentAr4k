...
public class EdgeStarterProperties {
  ...
  private String dnsConfig = "shared-agent-config.rossonet.com";
  ...
  public String toString() {
    return "Ar4kStarterProperties [uniqueName=" + uniqueName + ", uniqueNameFile=" + uniqueNameFile + ", confPath="
        ...
        + ", threadSleep=" + threadSleep + ", consoleOnly=" + consoleOnly + ", animaDatastoreFileName="
        + animaDatastoreFileName + ", test=" + test + ", logoUrl=" + logoUrl + "]";
  }
