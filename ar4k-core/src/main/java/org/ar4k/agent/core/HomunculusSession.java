...
public class HomunculusSession implements IHomunculusRpc {
	...
	protected final Log logger = LogFactory.getLog(HomunculusSession.class);
	private final ConcurrentMap<Object, Set<String>> principals;
	private final Map<String, SessionInformation> sessionIds;
	private final Map<String, RpcConversation> rpcIds;

	public HomunculusSession() {
		this.principals = new ConcurrentHashMap<>();
		this.sessionIds = new ConcurrentHashMap<>();
		this.rpcIds = new ConcurrentHashMap<>();
	}

	public HomunculusSession(ConcurrentMap<Object, Set<String>> principals,
	...
	public String toString() {
		return "HomunculusSession [getAllPrincipals()=" + getAllPrincipals() + "]";
	}
