 ...
 *
 *         Validatore da linea di comando per tipologia di connessione proxy.
 */
public class ProxyValidator implements IParameterValidator {

  @Override
  public void validate(String name, String value) throws ParameterException {
    try {
      Proxy.Type.valueOf(value);
    } catch (java.lang.IllegalArgumentException aa) {
      StringBuilder b = new StringBuilder();
      EnumSet.allOf(Proxy.Type.class).forEach(v -> {
        b.append(v.name() + " ");
      });
