...
public class MemorizeSequence {
	...
	// Add a special character at the beginning so the RNN learns the complete
	// string and ends with the marker.
	...
	public void mainTest() {
		...
		for (char currentChar : LEARNSTRING) {
			...
			// nextChar - not really required. Added to this hack by adding a starter first
			// character.
