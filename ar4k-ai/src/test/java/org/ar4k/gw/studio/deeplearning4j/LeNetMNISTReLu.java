...
import org.ar4k.gw.studio.deeplearning4j.utils.DataUtilities;
 ...
 * 1998. Gradient based learning applied to document recognition]</a> Some minor
 * changes are made to the architecture like using ReLU and identity activation
 * instead of sigmoid/tanh, max pooling instead of avg pooling and softmax
 * output layer.
 * <p>
...
public class LeNetMNISTReLu {
	...
	public void mainTest() throws Exception {
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().seed(seed).l2(0.0005) // ridge regression
																									// value
				.updater(new Nesterovs(new MapSchedule(ScheduleType.ITERATION, learningRateSchedule)))
				.weightInit(WeightInit.XAVIER).list()
				.layer(new ConvolutionLayer.Builder(5, 5).nIn(channels).stride(1, 1).nOut(20)
