...
import org.ar4k.gw.studio.deeplearning4j.utils.MathFunction;
import org.ar4k.gw.studio.deeplearning4j.utils.SinXDivXMathFunction;
...
public class MathFunctionsModel {
	 ...
	 * @param batchSize Batch size (number of quickstartexamples for every call of
	...
	private static void plot(final MathFunction function, final INDArray x, final INDArray y,
		...
		final JFreeChart chart = ChartFactory.createXYLineChart("Regression Example - " + function.getName(), // chart
																												// title
				"X", // x axis label
