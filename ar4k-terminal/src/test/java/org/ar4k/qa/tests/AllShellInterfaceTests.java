...
@Import({ SpringShellAutoConfiguration.class, JLineShellAutoConfiguration.class, Homunculus.class,
		...
		KeystoreShellInterface.class, BeaconShellInterface.class, DataShellInterface.class, ShellInterface.class,
		SshShellInterface.class })
...
public class AllShellInterfaceTests {
	...
	public void listCommandAndCheck() throws InterruptedException, IOException {
		...
		assertTrue(listCommands.containsKey("add-new-node-id-to-simulated-config"));
		assertTrue(listCommands.containsKey("add-simulated-config"));
		...
		assertTrue(listCommands.containsKey("clean-simulated-config"));
		...
		assertTrue(listCommands.containsKey("get-metrics"));
		...
		assertTrue(listCommands.containsKey("list-slave-data-address"));
		...
		assertTrue(listCommands.containsKey("register-data-channel"));
		...
		assertTrue(listCommands.containsKey("search-data-channels"));
