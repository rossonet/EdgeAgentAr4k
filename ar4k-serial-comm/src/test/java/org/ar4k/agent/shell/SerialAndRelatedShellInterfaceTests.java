...
import org.ar4k.agent.iot.serial.json.esp8266.NodeMcuLinkShellInterface;
...
@Import({ SpringShellAutoConfiguration.class, JLineShellAutoConfiguration.class, Anima.class,
    ...
    Ar4kAuthenticationManager.class, BCryptPasswordEncoder.class, SerialShellInterface.class, CncShellInterface.class,
    NodeMcuLinkShellInterface.class, SerialJsonShellInterface.class, MarlinShellInterface.class })
...
public class SerialAndRelatedShellInterfaceTests {
  ...
  public void listCommandAndCheck() throws InterruptedException, IOException {
    ...
    assertTrue(listCommands.containsKey("add-node-mcu-service"));
