 ...
 *
 *         Validatore governance tribù.
 */
public class TribeGovernanceValidator implements IParameterValidator {

  @Override
  public void validate(String name, String value) throws ParameterException {
    try {
      Governance.valueOf(value);
    } catch (java.lang.IllegalArgumentException aa) {
      StringBuilder b = new StringBuilder();
      EnumSet.allOf(Governance.class).forEach(v -> {
        b.append(v.toString() + " ");
      });
