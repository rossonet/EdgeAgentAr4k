...
public class HazelCastShellInterfaceTests {
  ...
  public void listCommandAndCheck() throws InterruptedException, IOException {
    ...
    assertTrue(listCommands.containsKey("add-tribe"));
    ...
    assertTrue(listCommands.containsKey("tribe-join"));
    assertTrue(listCommands.containsKey("tribe-list"));
    assertTrue(listCommands.containsKey("tribe-status"));
    assertTrue(listCommands.containsKey("tribe-stop"));
